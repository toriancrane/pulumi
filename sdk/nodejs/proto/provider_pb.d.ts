...
export class ConfigureRequest extends jspb.Message {
  ...
  setSendsOldInputs(value: boolean): void;

  getSendsOldInputsToDelete(): boolean;
  setSendsOldInputsToDelete(value: boolean): void;
...
export class ConfigureResponse extends jspb.Message {
  ...
  setSupportspreview(value: boolean): void;

  getAcceptresources(): boolean;
  setAcceptresources(value: boolean): void;

  getAcceptoutputs(): boolean;
  setAcceptoutputs(value: boolean): void;
...
export class CallRequest extends jspb.Message {
  ...
  setMonitorendpoint(value: string): void;
...
export class CheckRequest extends jspb.Message {
  ...
  setRandomseed(value: Uint8Array | string): void;
...
export class DiffRequest extends jspb.Message {
  ...
  setOldInputs(value?: google_protobuf_struct_pb.Struct): void;
...
export class PropertyDiff extends jspb.Message {
  getKind(): PropertyDiff.KindMap[keyof PropertyDiff.KindMap];
  setKind(value: PropertyDiff.KindMap[keyof PropertyDiff.KindMap]): void;
...
export namespace PropertyDiff {
  export type AsObject = {
    kind: PropertyDiff.KindMap[keyof PropertyDiff.KindMap],
    inputdiff: boolean,
  }
...
export class DiffResponse extends jspb.Message {
  ...
  getChanges(): DiffResponse.DiffChangesMap[keyof DiffResponse.DiffChangesMap];
  setChanges(value: DiffResponse.DiffChangesMap[keyof DiffResponse.DiffChangesMap]): void;
...
export namespace DiffResponse {
  export type AsObject = {
    ...
    changes: DiffResponse.DiffChangesMap[keyof DiffResponse.DiffChangesMap],
    diffsList: Array<string>,
    detaileddiffMap: Array<[string, PropertyDiff.AsObject]>,
    hasdetaileddiff: boolean,
  }

  export interface DiffChangesMap {
    DIFF_UNKNOWN: 0;
    DIFF_NONE: 1;
    DIFF_SOME: 2;
  }

  export const DiffChanges: DiffChangesMap;
}
...
export class ConstructRequest extends jspb.Message {
  ...
  setCustomtimeouts(value?: ConstructRequest.CustomTimeouts): void;
...
export class ConstructResponse extends jspb.Message {
  ...
  setState(value?: google_protobuf_struct_pb.Struct): void;
