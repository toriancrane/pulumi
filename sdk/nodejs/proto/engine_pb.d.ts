...
export class LogRequest extends jspb.Message {
  getSeverity(): LogSeverityMap[keyof LogSeverityMap];
  setSeverity(value: LogSeverityMap[keyof LogSeverityMap]): void;
...
export namespace LogRequest {
  export type AsObject = {
    severity: LogSeverityMap[keyof LogSeverityMap],
    message: string,
    urn: string,
    streamid: number,
    ephemeral: boolean,
...
export const LogSeverity: LogSeverityMap;
